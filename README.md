...
| [`scverse_scrna_annotate`](templates/scverse_scrna_annotate/linkar_template.yaml) | Create and run an editable Python-only scverse/Scanpy single-cell RNA-seq annotation workspace with a commented YAML config, a shared overview report, and method-specific sub-reports such as CellTypist. | [README](templates/scverse_scrna_annotate/README.md) |
