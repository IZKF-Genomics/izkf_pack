...
- [docs/scverse_scrna_annotate.md](docs/scverse_scrna_annotate.md): annotation-specific assumptions for the scRNA annotation workspace
...
| [`scverse_scrna_annotate`](templates/scverse_scrna_annotate/linkar_template.yaml) | Create and run an editable scverse/Scanpy single-cell RNA-seq annotation workspace with a shared overview report plus method-specific sub-reports such as CellTypist. | [README](templates/scverse_scrna_annotate/README.md) |
...
python3 templates/scverse_scrna_annotate/test.py
```
