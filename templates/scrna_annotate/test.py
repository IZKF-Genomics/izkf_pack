...
PY""",
    ...
    visible_project = Path(tmp) / "visible_project"
    ...
    assert load_function("get_scrna_annotate_input_h5ad")(rendered_ctx) == str(visible_h5ad)
    assert load_function("get_scrna_annotate_input_source_template")(rendered_ctx) == "scrna_prep"
